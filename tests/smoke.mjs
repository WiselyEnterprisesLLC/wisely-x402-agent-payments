...
for (const url of urls) {
  const res = await fetch(url, { headers: { "user-agent": "wisely-x402-public-smoke/2.1.6" } });
...
const recommend = await fetch("https://payments.wiselyenterprisesllc.com/ai/creator-catalogs/demo-sales-framework/recommend", {
  method: "POST",
  headers: { "content-type": "application/json", "user-agent": "wisely-x402-public-smoke/2.1.6" },
  body: JSON.stringify({
